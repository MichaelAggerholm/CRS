            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="employee_number" value="{{ $employee->employee_number }}" class="form-control" placeholder="Employee_number">
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        <strong>Hired_date:</strong>
                        <input type="date" name="hired_date" value="{{ $employee->hired_date }}" class="form-control" placeholder="Hired_date">
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        <strong>City:</strong>
                        <input type="text" name="city" value="{{ $employee->city }}" class="form-control" placeholder="City">
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <input type="number" name="postal_code" value="{{ $employee->postal_code }}" class="form-control" placeholder="Postal_code">
                    </div>
                </div>
